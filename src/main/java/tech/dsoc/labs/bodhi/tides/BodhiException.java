...
public class BodhiException extends RuntimeException {
  static final String NEED_TO_SUPPLY_EVENTS =
      "You need to supply an ascending ordered list of tidal events";

  static final String EVENTS_IN_PAST =
      "All the events are in the past (or they aren't ascending ordered)";
  /**
